...
private:
    ...
    float MissionTime;
    float MissionTimePart; // Could be removed when migrating to C++, temp variable holds Part 1's MissionTime for Part 2 of the level due to lack of persistent data.
